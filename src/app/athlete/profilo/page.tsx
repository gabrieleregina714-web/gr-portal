    ...
    <div className="-mx-4 sm:-mx-6 md:-mx-8 lg:-mx-10 -mt-5 sm:-mt-6 md:-mt-8">
      ...
      <div className="px-6 lg:px-10 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.04]">
            {[
              ...
              <div key={i} className="bg-[#0A0A0A] px-5 py-4 flex items-center gap-3">
                <span className="text-white/50 shrink-0">{item.icon}</span>
                <div>
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">{item.label}</p>
            ...
            <div className="p-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.04]">
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Piano</p>
                  <p className="text-[14px] text-white/50">{sub.planName}</p>
                </div>
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Stato</p>
                  <p className="text-[14px] text-white/50">{sub.status === 'active' ? 'Attivo' : sub.status === 'paused' ? 'In pausa' : sub.status}</p>
                </div>
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Importo</p>
                  <p className="text-[14px] text-white/50">€{sub.amount}/mese</p>
                </div>
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Prossimo pagamento</p>
                  <p className="text-[14px] text-white/50">{sub.nextPayment}</p>
                </div>
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Data inizio</p>
                  <p className="text-[14px] text-white/50">{sub.startDate}</p>
                </div>
                <div className="bg-[#0A0A0A] px-5 py-4">
                  <p className="text-[11px] uppercase tracking-[0.15em] text-white/50 mb-0.5">Rinnovo automatico</p>
        ...
        <div className="border-t border-white/[0.04] pt-6 text-center">
          <p className="text-[11px] text-white/50 uppercase tracking-[0.2em]">Per modifiche al profilo o all&apos;abbonamento contatta il tuo coach</p>
        </div>
      </div>
    </div>
  );
