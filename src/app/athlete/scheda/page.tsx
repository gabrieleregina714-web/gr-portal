          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.06]">
              <div className="bg-[#0A0A0A] p-5">
                <p className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-2">Programma</p>
            ...
            <div className="border border-white/[0.06] p-5">
              <p className="text-[12px] text-white/65 leading-relaxed">{currentPlan.description}</p>
            </div>
                        ...
                        <table className="w-full min-w-[500px]">
                          <thead>
                            <tr className="border-b border-white/[0.04]">
                              <th className="text-left px-4 sm:px-6 py-2.5 text-[11px] uppercase tracking-[0.15em] text-white/60 w-[35%]">Esercizio</th>
                              <th className="text-center px-2 sm:px-3 py-2.5 text-[11px] uppercase tracking-[0.15em] text-white/60">Serie</th>
                              <th className="text-center px-2 sm:px-3 py-2.5 text-[11px] uppercase tracking-[0.15em] text-white/60">Reps</th>
                              <th className="text-center px-2 sm:px-3 py-2.5 text-[11px] uppercase tracking-[0.15em] text-white/60">Recupero</th>
                              <th className="text-left px-2 sm:px-3 py-2.5 text-[11px] uppercase tracking-[0.15em] text-white/60">Note</th>
                            </tr>
                          </thead>
                          <tbody>
        ...
        {schemaDocs.length > 0 && (
          <div className="border border-white/[0.06]">
            <div className="px-5 py-3 border-b border-white/[0.06]">
              <p className="text-[10px] uppercase tracking-[0.2em] text-white/60">Schede scaricabili</p>
            </div>
